...
func elegir_animacion_aleatoria() -> String:
	...
	var indice_anim_aletorio: int = randi() % num_anim + 1 
	var lista_animacion: Array = $AnimationPlayer.get_animation_list()
	return lista_animacion[indice_anim_aletorio]
...
func destruir() -> void: 
	var posicion_partes = [$Sprites/Sprite.global_position,
	$Sprites/Sprite2.global_position, $Sprites/Sprite3.global_position,
...
func deteccion_cuadrante() -> Vector2:
	...
	elif abs(angulo_player) > 45.0 and abs(angulo_player) <= 130.0:
		#Player entra por por arriba o por abajo
