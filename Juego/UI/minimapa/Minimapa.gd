...
export var tiempo_visible: float = 30.0
...
##Atributos Onready 
onready var zona_renderizado: TextureRect = $CuadradoMiniMapa/ContenedorIconos/ZonaRenderizadoMiniMapa
onready var icono_player: Sprite = $CuadradoMiniMapa/ContenedorIconos/ZonaRenderizadoMiniMapa/IconoPlayer
onready var icono_estacion: Sprite = $CuadradoMiniMapa/ContenedorIconos/ZonaRenderizadoMiniMapa/EstacionRecarga
onready var icono_base: Sprite = $CuadradoMiniMapa/ContenedorIconos/ZonaRenderizadoMiniMapa/BaseEnemiga
onready var items_mini_mapa: Dictionary = {}
onready var icono_interceptor: Sprite = $CuadradoMiniMapa/ContenedorIconos/ZonaRenderizadoMiniMapa/IconoInterceptor
onready var icono_rele: Sprite = $CuadradoMiniMapa/ContenedorIconos/ZonaRenderizadoMiniMapa/IconoRele
...
func set_esta_visible(hacer_visible: bool) -> void:
	...
	tween_visibilidad.interpolate_property(self, "modulate", Color(1,1,1, not hacer_visible),
	Color(1, 1, 1, hacer_visible), 0.5, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
...
func obtener_objetos_minimapa() ->void:
	...
	for objeto in objetos_en_ventana:
		if not items_mini_mapa.has(objeto):
			...
			elif objeto is EnemigoInteceptor:
